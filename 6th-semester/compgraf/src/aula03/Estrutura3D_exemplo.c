...
void Display()
{
   ...
   glEnable(GL_DEPTH_TEST);/*Realize teste de profundidade por amostra (frame) em rela��o ao volume e seus limites. 
   Se o teste falhar, o fragmento � descartado. Se o teste for aprovado, o buffer de profundidade ser� atualizado*/
   ...
   glEnable(GL_BLEND);/*Pixels podem ser desenhados combinando o espa�o de cor RGBA de entrada (origem) com 
   os valores RGBA que j� est�o no buffer (frame).*/
   ...
   //glPushMatrix(); //Salva o estado atual da cena. O que for desenhado ap�s o Push n�o influenciar� o j� representado
      glColor3ub(100, 255, 40); //DEFINE cor (R, G, B)
      glutSolidTeapot(5.0);
